  ...
  >
    <div class="navbar-container d-flex content">
      ...
      <ul class="nav navbar-nav align-items-center ml-auto">
        ...
        <li class="nav-item d-none d-lg-block">
          <a class="nav-link nav-link-style" data-prev-layout="bordered-layout"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              ...
              <a class="d-flex" href="javascript:void(0)">
                <div class="media d-flex align-items-start">
                  <div class="media-left">
                    <div class="avatar">
                      <img
                        src="../../public/images/portrait/small/avatar-s-15.jpg"
                        alt="avatar"
                        width="32"
                        height="32"
                      />
              ...
              ><a class="d-flex" href="javascript:void(0)">
                <div class="media d-flex align-items-start">
                  <div class="media-left">
                    <div class="avatar">
                      <img
                        src="../../public/images/portrait/small/avatar-s-3.jpg"
                        alt="avatar"
                        width="32"
                        height="32"
                      />
        ...
        <li class="nav-item dropdown dropdown-user">
          ...
          >
            ...
            <span class="avatar"
              ><img
                class="round"
                src="../../public/images/portrait/small/avatar-s-11.jpg"
                alt="avatar"
                height="40"
          ...
          >
            ...
            ><a class="dropdown-item" href="app-email.html"
              ><svg
                ...
                stroke-linecap="round"
                stroke-linejoin="round"
                class="feather feather-mail mr-50"
              >
                <path
                  d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"
                ></path>
